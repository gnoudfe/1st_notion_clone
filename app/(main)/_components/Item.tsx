      ...
      {!!id && (
        <div className="ml-auto flex items-center gap-x-2">
          <DropdownMenu>
            ...
            >
              <div
                className=" cursor-pointer flex items-center rounded-sm py-1.5 pl-2 pr-2 text-sm outline-none transition-all ease-in-out duration-300  hover:bg-neutral-300 dark:hover:bg-neutral-600"
                onClick={onArchive}
              >
